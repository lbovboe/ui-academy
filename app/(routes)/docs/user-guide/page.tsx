  ...
  const content = {
    ...
    sections: {
      gettingStarted: {
        ...
        items: [
          { description: language === 'en' ? 'Visit the main page' : '访问主页' },
          {
            description:
              language === 'en' ? 'Browse available novels or import your own' : '浏览可用小说或导入您自己的小说',
          },
          { description: language === 'en' ? 'Click on a novel to start reading' : '点击小说开始阅读' },
        ] as DocItem[],
      },
      readingNovel: {
        ...
        items: [
          {
            ...
            codeBlock: <DocCodeBlock code="npm run scrape <url>" />,
          },
          {
            description:
              language === 'en' ? (
      ...
      convertingText: {
        ...
        items: [
          { description: language === 'en' ? 'Go to the Text Tools section' : '转到"文本工具"部分' },
          { description: language === 'en' ? 'Select your conversion preference' : '选择您的转换首选项' },
          { description: language === 'en' ? 'Import your text' : '导入您的文本' },
          { description: language === 'en' ? 'Download the converted text' : '下载转换后的文本' },
        ] as DocItem[],
      },
      usingAsPWA: {
        ...
        items: [
          { description: language === 'en' ? 'Visit the website in a supported browser' : '使用支持的浏览器访问网站' },
          {
            description:
              language === 'en'
